...
from apps.reports.views import DashboardSummaryView, DistrictReportView, BranchReportView, TechnicianReportView, ATMReportView, GlobalSearchView, MaintenanceReportView
